...
# Ruxsat berilgan foydalanuvchilar (admin doim kirishi mumkin)
...
async def request_access(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "⏳ Siz uchun ruxsat so'rovi yuborildi. Admin tasdiqlashini kuting."
    )

# === CALLBACK HANDLER (RUXSAT/RAD) ===
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "allow":
        ...
        await context.bot.send_message(
            chat_id=user_id,
            text="❌ Kechirasiz, sizga ruxsat berilmadi. Admin bilan bog'laning."
        )
